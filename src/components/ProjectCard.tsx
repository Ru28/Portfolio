            ...
            <div className="lg:col-span-6">
                <div className="flex-col space-y-1.5 p-6 flex">
                    <h3 className="text-2xl font-semibold leading-none tracking-tight flex items-center justify-between">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mr-2"><path d="M8 6h10"></path><path d="M6 12h9"></path><path d="M11 18h7"></path></svg>
                        Medium
                        </div>
                        <div className='flex gap-2'>
                            ...
                            <a target='_blank' className='hover:text-blue-500 transition-all' href='https://github.com/Ru28'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="h-5 w-5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" x2="21" y1="14" y2="3"></line></svg>
                            </a>
                        </div>
                    </h3>
